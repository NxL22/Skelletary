...
//
// NOTA: este archivo es un duplicado intencional de
// `supabase/functions/assistant-report/lib/feedback.js`. Supabase
// deploya cada Edge Function con su propio bundle, por lo que no se
// puede compartir codigo entre funciones via imports relativos. Si
// modifica la logica de feedback, mantenga ambas copias sincronizadas.
// =====================================================================
//
 ...
 * - Trunca a los ultimos MAX_FEEDBACK_ENTRIES para acotar el tamano.
 */
